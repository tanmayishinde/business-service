...
public final class PlanProductUtil {
    ...
    public static List<MonthlyDisplayVO> getMonthlyPlanDisplayList(
            List<MonthlyPlanEntityVO> monthlyPlanEntityVOList,
            RedisContextWrapper redisContextWrapper) throws ValidationException {
